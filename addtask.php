  ...
  <div class="container" style="color:black"> 
    <form method="post" action="index.php" >
      ...
      <div class="form-group">
        ...
        <input type="date" name="createddate" class="form-control" id="createddate" placeholder="0000-00-00" >
      </div>
      <div class="form-group">
        <label>Due Date:</label>
        <input type="date" name="duedate" class="form-control" id="duedate" placeholder="0000-00-00">
      </div>
      <div class="form-group">
